...
export default function Home() {
  ...
  return (
    <div className="relative flex h-[100dvh] min-h-screen flex-col overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-[-12rem] top-[-8rem] h-72 w-72 rounded-full bg-neutral-500/20 blur-3xl" />
        <div className="absolute right-[-10rem] top-24 h-80 w-80 rounded-full bg-zinc-400/20 blur-3xl" />
        <div className="absolute bottom-[-8rem] left-1/3 h-72 w-72 rounded-full bg-stone-300/12 blur-3xl" />
        <div className="absolute left-1/3 top-1/4 h-64 w-64 rounded-full bg-neutral-400/12 blur-3xl" />
      </div>
      ...
      <div className="relative flex min-h-0 flex-1 gap-5 px-4 pb-4 pt-5 sm:px-6 sm:pb-6 sm:pt-5">
        <aside className="hidden min-h-0 md:block md:w-64 md:shrink-0">
          ...
          {isSidebarOpen ? (
            <>
              ...
              <motion.aside
                ...
                className="fixed inset-y-0 left-0 z-50 h-[100dvh] w-[88vw] max-w-[360px] p-3 shadow-2xl md:hidden"
              >
                <Sidebar
                  games={filteredGames}
                  selectedGame={visibleSelectedGame}
